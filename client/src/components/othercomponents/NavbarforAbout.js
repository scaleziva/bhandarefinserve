...
// import Logo from "../Bhandare Finserve - Logo.png";
...
const NavbarForAbout = () => {
    ...
    const [imgLogo, setimgLogog] = useState(DarkLogo);
                ...
                <div className={`servNavMain ${forNavBg} ${addShadow}`}>
                    <div className="servNav">
                        ...
                        <nav class={`navbar navbar-expand-lg bg-transparent`}>
                            <img onClick={navigateToHome} src={imgLogo} alt="" style={{cursor:"pointer"}} className="servicesLogoNav"/>
