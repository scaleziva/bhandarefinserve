...
import MainBg from "./images/Life Insurance.jpg";
    ...
    return (
        <>
                ...
                <div className="dflexlol">
                    <div className="loansMain">
                        ...
                        <div className="loansSubFirst" >
                            <h3> Your Life is Uncertain</h3>
                            <h2>
                                But your Coverage shouldn’t be! <br />
            ...
            <div className="loansPart2Main" >
                ...
                <div className="loansPart2">
                    ...
                    <center style={{ width: "100%" }} >
                        {/* <h5 style={{ fontFamily: "Montserrat", fontWeight: "bolder", fontSize: "25px", marginTop: "50px" }} >Life Insurance <br /> Invest in your Legacy</h5> */}
                        {/* <h1 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px auto" }} >Life Insurance : Safety Net of your Family</h1> */}
                        <h1 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px auto", marginTop: "40px" }} >Life Insurance : Invest in your Legacy</h1>
                    </center>
                    ...
                    <div className="loansPart2Sub">
                        ...
                        <div>
                            <p>At Bhandare Finserve, we understand that protecting your loved ones is a top priority. That's why we work with several banks to bring you life insurance at a low cost and with quick documentation. Our life insurance policies provide peace of mind for you and your family, ensuring that they are taken care of in the event of an unexpected tragedy.</p>
                            <p>We believe that life insurance should be accessible to everyone, which is why we work tirelessly to find you the best deals and policies. We take pride in our commitment to excellence and personalized service, ensuring that each and every one of our clients get the coverage they need and deserve.</p>
                            <p>Our experienced financial team ensures that the complete process, from applying for suitable insurance to the disbursal of the amount, happens smoothly and without any hassle. The process is seamless and just takes 2-3 days after the verification of submitted documents. </p>
                        </div>
                    </div>
                    <p className="loansPara" >So, Apply for the Insurance today, and let us help you find the right life insurance policy to meet your needs. <br /> Trust us to be your partner in securing your family's future!
                    </p>
                ...
                <div className="LoansCalc" onMouseEnter={calculateEmi()}  >
                    ...
                    <h1 style={{ fontFamily: "Montserrat", fontWeight: "bolder", marginBottom: "50px", textAlign: "center", marginTop: "17px" }} > Life Insurance Premium Calculator</h1>
            ...
            <div className="loansProcessMain" >
                ...
                <h1 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "20px 10px", textAlign: "center" }} >How to Apply for a Life Insurance Policy?</h1>
                <p style={{ fontFamily: "Montserrat", fontWeight: "400", margin: "20px auto", padding: "10px", width: "90%", maxWidth: "1200px", textAlign: "center" }}  >Ahoy there! When it comes to applying for a Life Insurance, different Policies have different sets of rules and requirements. At Bhandare Finserve, we make the process as smooth as silk, but you'll still need to provide a fully filled-out application form, a recent photo, and a few other documents. Here are some papers you'll likely need to verify</p>
            ...
            <div className="eligibilityLoansMain" >
                <center className="centerEligi" >
                    ...
                    <h2 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px 10px", textAlign: "center" }} >Are you Eligible to Insure your life?</h2>
                    <p style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px auto", padding: "10px", width: "90%", maxWidth: "900px", textAlign: "center" }}  >We've rounded up the top eligibility criteria that our network of financial institutions typically look for when processing Life Insurance Policies. Take a peek below to see if you meet the mark!</p>
                </center>
            ...
            <div className="benefitsLoans" >
                <center>
                    ...
                    <h2 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px auto" }} >Dreaming of a new home? Let's see if you're eligible to make it a reality!</h2>
                </center>
