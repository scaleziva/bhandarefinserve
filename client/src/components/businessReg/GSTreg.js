...
import MainBg from "./images/GST Registration.jpg"
                ...
                <div className="dflexlol">
                    <div className="loansMain">
                        ...
                        <div className="loansSubFirst" >
                            <h3>Streamline your Business</h3>
                            <h2>Register your GST now</h2>
                        </div>
            ...
            <div className="loansPart2Main" >
                ...
                <div className="loansPart2">
                    ...
                    <center style={{ width: "100%" }} >
                        ...
                        <h1 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px auto" }} >GST Registration : Get Registered , Get Compliant</h1>
                    </center>
                    ...
                    <div className="loansPart2Sub">
                        ...
                        <div>
                            <p> Launched on 1 July 2017, the Goods & Services Tax (GST) applies to all Indian service providers (including freelancers), traders and manufacturers. A variety of Central taxes like Service Tax, Excise Duty, CST and state taxes like Entertainment Tax, Luxury Tax, Octroi, VAT are accumulated in the GST. </p>
                            <p>Looking to get GST registered, but dreading the paperwork and the complicated processes? Worry not, because Bhandare Finserve is here to make the process of GST registration a breeze! With our team of experts, we offer comprehensive assistance in all aspects of GST registration. From guidance on necessary documentation to application submission and follow-up with the authorities, we've got you covered every step of the way. </p>
                            <p>At Bhandare Finserve, we understand that your time is valuable, which is why we offer quick documentation and a hassle-free process. Say goodbye to tedious paperwork and hello to seamless processes that will have you registered for GST in no time. </p>
                        </div>
                    </div>
                    <p className="loansPara" > Our experts will keep track of the progress of your application and provide you with regular updates on the status of your GST registration. With our help, you can rest assured that the entire process will be smooth and hassle-free.  </p>
                    <p className="loansPara" > So why wait? Let Bhandare Finserve help you get GST registered and take your business to the next level.  </p>
                ...
                <div className="loansProcessMain" >
                    ...
                    <h1 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "20px 10px", textAlign: "center" }} >How to Apply for GST Registration ?</h1>
                    <p style={{ fontFamily: "Montserrat", fontWeight: "400", margin: "20px auto", padding: "10px", width: "90%", maxWidth: "1200px", textAlign: "center" }}  >Ahoy there! When it comes to applying for GST Registration there are different sets of rules and requirements. At Bhandare Finserve, we make the process as smooth as silk, but you'll still need to provide a fully filled-out application form, a recent photo, and a few other documents as per the requirements.</p>
                ...
                {/* <div className="eligibilityLoansMain" >
                    <center style={{ width: "100%" }} >
                        ...
                        <h2 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px 10px", textAlign: "center" }} >What makes you eligible for GST Registration ?</h2>
                        <p style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px auto", padding: "10px", width: "90%", maxWidth: "900px", textAlign: "center" }}  >We've rounded up the top eligibility criteria that is required while applying for GST Registration</p>
                    </center>
                ...
                <div className="benefitsLoans" >
                    <center style={{ width: "100%" }} >
                        ...
                        <h2 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px auto" }} >Here’s Why People Choose BFS for GST Registration !</h2>
                    </center>
