...
import MainBg from "./images/MSME.jpg"
            ...
            <div className="loansPart2Main" >
                ...
                <div className="loansPart2">
                    ...
                    <center style={{ width: "100%" }} >
                        ...
                        <h1 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px auto" }} >MSME Registration : Small Business , Huge Growth</h1>
                    </center>
                    ...
                    <div className="loansPart2Sub">
                        ...
                        <div>
                            <p>Ready to take your business to the next level with MSME registration?</p>
                            <p>We know the process can be overwhelming, but fear not because Bhandare Finserve is here to simplify the process for you. Our team of experts is well-equipped in all aspects of MSME registration and will provide you with end-to-end assistance.</p>
                            <p>We'll guide you through the necessary documentation, submit your application, and follow up with the authorities, ensuring a hassle-free process. </p>
                            <p>At Bhandare Finserve, we value your time, which is why we offer quick documentation and seamless processes to get your MSME registration completed in no time. With our help, you can be assured that the entire process will be smooth and stress-free. Our experts will keep track of your application's progress and provide you with regular updates on the status of your MSME registration. </p>
                        </div>
                    </div>
                    <p className="loansPara" > Don't let the paperwork and complicated processes hold you back from achieving your business goals.
                        <br />    Let Bhandare Finserve help you get your MSME registered and take your business to new heights.
                    </p>
                ...
                <div className="loansProcessMain" >
                    ...
                    <h1 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "20px 10px", textAlign: "center" }} >How to Apply for MSME Registration ?</h1>
                    <p style={{ fontFamily: "Montserrat", fontWeight: "400", margin: "20px auto", padding: "10px", width: "90%", maxWidth: "1200px", textAlign: "center" }}  >Ahoy there! When it comes to applying for MSME Registration there are different sets of rules and requirements. At Bhandare Finserve, we make the process as smooth as silk, but you'll still need to provide a fully filled-out application form, a recent photo, and a few other documents as per the requirements.</p>
                ...
                {/* <div className="eligibilityLoansMain" >
                    <center style={{width:"100%"}} >
                        ...
                        <h2 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px 10px", textAlign: "center" }} >What makes you eligible for MSME Registration ?</h2>
                        <p style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px auto", padding: "10px", width: "90%", maxWidth: "900px", textAlign: "center" }}  >We've rounded up the top eligibility criteria that is required while applying for MSME Registration</p>
                    </center>
                ...
                <div className="benefitsLoans" >
                    <center style={{ width: "100%" }} >
                        ...
                        <h2 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px auto" }} >Here’s Why People Choose BFS for MSME Registration !</h2>
                    </center>
