...
import MainBg from "./images/Trade License.jpg"
                ...
                <div className="dflexlol">
                    <div className="loansMain">
                        ...
                        <div className="loansSubFirst" >
                            <h3> Legitimize your Business </h3>
                            <h2>Get your Trade License now !</h2>
                        </div>
            ...
            <div className="loansPart2Main" >
                ...
                <div className="loansPart2">
                    ...
                    <center style={{ width: "100%" }} >
                        ...
                        <h1 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px auto" }} >Trade License : Trade & Grow Substantially</h1>
                    </center>
                    ...
                    <div className="loansPart2Sub">
                        ...
                        <div>
                            <p>Trade licensing is an essential requirement for any business operating in India, as it authorizes a company to engage in trading activities within a specified geographic area. </p>
                            <p>A trade license is a legal document that ensures compliance with the country's trade regulations and laws. The process of obtaining a trade license in India can be complex and time-consuming, which can be a daunting task for businesses. </p>
                            <p>However, with the assistance of Bhandare Finserve, a leading financial services provider in India, the process can be easier and hassle-free. Bhandare Finserve understands the significance of obtaining a trade license for businesses, and hence, it provides comprehensive guidance in this regard. The company offers a range of services, including assistance with documentation, application submission, and follow-up with the concerned authorities. </p>
                            <p>Bhandare Finserve's team of experts ensures that the entire process is smooth and stress-free for businesses. They keep track of the application's progress and update clients on the status of their trade license application. </p>
                        </div>
                    </div>
                    <p className="loansPara" > In addition, the company provides a quick and hassle-free documentation process, enabling businesses to focus on their core operations. With Bhandare Finserve's assistance, businesses can obtain their trade license quickly and efficiently. Apply now for your Trade License with Bhandare Finserve's expert assistance.</p>
                ...
                <div className="loansProcessMain" >
                    ...
                    <h1 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "20px 10px", textAlign: "center" }} >How to Apply for a Trade License?</h1>
                    <p style={{ fontFamily: "Montserrat", fontWeight: "400", margin: "20px auto", padding: "10px", width: "90%", maxWidth: "1200px", textAlign: "center" }}  >Ahoy there! When it comes to applying for a Trade License there are different sets of rules and requirements. At Bhandare Finserve, we make the process as smooth as silk, but you'll still need to provide a fully filled-out application form, a recent photo, and a few other documents as per the requirements.</p>
                ...
                {/* <div className="eligibilityLoansMain" >
                    <center style={{ width: "100%" }} >
                        ...
                        <h2 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px 10px", textAlign: "center" }} >What makes you eligible for Trade License ?</h2>
                        <p style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px auto", padding: "10px", width: "90%", maxWidth: "900px", textAlign: "center" }}  >We've rounded up the top eligibility criteria that is required while applying for a Trade License</p>
                    </center>
                ...
                <div className="benefitsLoans" >
                    <center style={{ width: "100%" }} >
                        ...
                        <h2 style={{ fontFamily: "Montserrat", fontWeight: "bolder", margin: "25px auto" }} >Here’s Why People Choose BFS for Trade Licensing !</h2>
                    </center>
