...
import MainBg from "./images/Accounting.jpg";
            ...
            <div className="loansPart2Main" >
                ...
                <div className="loansPart2">
                    ...
                    <div className="loansPart2Sub">
                        ...
                        <div>
                            <p>Looking for reliable and hassle-free accounting services that can help take your business to new heights? Look no further than Bhandare Finserve!</p>
                            <p>We offer a wide range of accounting services including bookkeeping & payroll management, and much more. Our team of experts is dedicated to providing you with seamless and hassle-free accounting solutions.</p>
                            <p>We understand that managing your finances can be a daunting task, which is why we offer quick documentation and a streamlined process that will have you up and running in no time. With Bhandare Finserve, you can rest assured that your finances are in good hands. Our experts will keep track of all your financial transactions, ensuring that everything is recorded accurately and up-to-date.</p>
                        </div>
                    </div>
                    <p className="loansPara" >We also offer payroll management services, so you can focus on growing your business while we take care of the administrative tasks. At Bhandare Finserve, we believe in providing personalized solutions that cater to the unique needs of your business. That's why we work closely with our clients to understand their financial goals and objectives, and develop customized accounting solutions that meet their specific needs. </p>
                    <p className="loansPara text-dark" >So why wait? <br />
                        Let Bhandare Finserve help you streamline your accounting processes and take your business to new heights. <br />
                        Contact us today to learn more about our accounting services and how we can help you achieve your financial goals.
                    </p>
                ...
                <div className="loansProcessMain" >
                    ...
                    <p style={{ fontFamily: "Montserrat", fontWeight: "400", margin: "20px auto", padding: "10px", width: "90%", maxWidth: "1200px", textAlign: "center" }}  >Ahoy there! When it comes to Book keeping & Payroll Management there is a specific protocol to be followed. At Bhandare Finserve, we make the process as smooth as silk, but you'll still need to provide a fully filled-out application form, a recent photo, and a few other documents as per the requirements.</p>
